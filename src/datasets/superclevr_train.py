...
class SuperCLEVRTrain(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # if self.bg_path:
        #     bg_dir = os.path.join(self.bg_path, self.category, self.split)
        ...
        ### Xiaoding DEBUG ####
        if item < 20:
            img.save("/home/xiaoding/Synthetic_NeMo/data/train_example_img/{}_bg{}_{}.png".format(img_name, idx, item))
    ...
    def new_debug(self, item, save_dir=""):
