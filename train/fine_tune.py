...
P3D_ignore_files = {
    'aeroplane': ["n02690373_5917", "n03335030_14777", "n04012084_1880", "n04012084_3681", "n04012084_905", "n04012084_991"],
    'bicycle': [],
    'boat': ["n03141327_15611", "n04196502_24999"],
    'bottle': ["n04557648_2742"],
    'bus': [],
    'car': ["n04037443_21947", "n04037443_4668"],
    'chair': [],
    'diningtable': [],
    'motorbike': [],
    'sofa': [],
    'train': ["n03711044_482", "n03896233_1153", "n03896233_7530"],
    'tvmonitor': []
}
...
def parse_args():
    ...
    # General args
    parser.add_argument('--exp_name', type=str, default='pseudo')
    ...
    parser.add_argument('--obj_mask_path', type=str, default=None)
    ...
    parser.add_argument('--test_result_file', type=str)
...
def prepare_data_pseudo(args):
    ...
    # Special note: ignore_files includes the images in PASCAL3D+_release1.1 that have no annotation.
    #               Will exclude them from the training data.
    train_dataset = PASCAL3DPTrain(
        img_path=f'../data/PASCAL3D+_release1.1/Images/{args.category}_imagenet',
        anno_path=f'../data/PASCAL3D+_release1.1/Annotations/{args.category}_imagenet',
        list_file=f'../data/PASCAL3D+_release1.1/Image_sets/{args.category}_imagenet_train.txt',
        ...
        dist=args.distance,
        split='train',
        ignore_files=P3D_ignore_files[args.category],
    )

    # # # DEBUG: find the ignore files mentioned above.
...
def main():
    # for cate in ['aeroplane', 'bicycle', 'boat', 'bottle', 'bus', 'car',
    #              'chair', 'diningtable', 'motorbike', 'sofa', 'train', 'tvmonitor']:
    args = parse_args()
    exp_name = f'{args.exp_name}_{args.category}'
    # args.category = cate
    args.iterations = 1000
    args.save_itr = 1000
    if args.category in ['bus', 'car', 'motorbike', 'aeroplane', 'bicycle', 'boat', 'diningtable', 'train']:
        args.distance = 6
    if args.category in ['chair', 'bottle']:
        # args.distance = 10
        args.distance = 6
    if args.category in ['sofa', 'tvmonitor']:
        # args.distance = 8
        args.distance = 6
    ...
    args.n = load_off(os.path.join(args.mesh_path, args.category, '01.off'))[0].shape[0]
