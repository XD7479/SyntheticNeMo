...
def prepare_data_pseudo(args):
    ...
    test_result_file = os.path.join(args.test_result_file, "{}_train.npy".format(args.category))
    npy = np.load(test_result_file, allow_pickle=True)[()]
    npy = npy['pred']
    ...
    train_dataset = PASCAL3DPTrain(
        ...
        list_file=f'{args.test_result_file}/{args.category}_100.txt',
...
def prepare_data_ood(args):
    ...
    npy = np.load(f'/home/jiahao/pretrain_6d_pose/test_pascal3d/exp0811/{args.category}_pseudo.npy', allow_pickle=True)[
         ()]
    npy = npy['pred']
