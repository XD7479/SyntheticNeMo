...
def parse_args():
    ...
    # General args
    parser.add_argument('--exp_name', type=str, default='apr22_superclevr_wagon_fast')
    parser.add_argument('--category', type=str, default='bus')
    parser.add_argument('--ngpus', type=int, default=1)
    parser.add_argument('--save_path', type=str, default='/home/jiahao/pretrain_6d_pose/experiments')
    ...
    # Data args
    parser.add_argument('--dataset', type=str, default='superCLEVR')
    parser.add_argument('--mesh_path', type=str, default='/home/jiahao/pretrain_6d_pose/data/CAD_cate')
    parser.add_argument('--dataset_path', type=str, default='/home/jiahao/pretrain_6d_pose/data/superclevr0719')
    parser.add_argument('--distance', type=float, default=6)
    parser.add_argument('--obj_mask_path', type=str,
                        default='/home/jiahao/pretrain_6d_pose/data/SuperCLEVR_20220808/masks')
    ...
    # dataset_val_path = os.path.join(args.dataset_path, 'val')
    # args.val_img_path = os.path.join(dataset_val_path, 'images')
    # args.val_anno_path = os.path.join(dataset_val_path, 'annotations')
...
def prepare_data(args):
    ...
    split = 'train'
    filename_prefix = f'{args.filename_prefix}_{split}'
    ...
    # train_dataset.debug(1)
    # train_dataset.debug(2)
    # exit()

    # npy = np.load('/home/jiahao/pretrain_6d_pose/test_pascal3d/exp0811/1013_bus_o_train.npy', allow_pickle=True)[()]
    # npy = npy['pred']
    # train_dataset = PASCAL3DPTrain(
    #     img_path='/home/jiahao/pretrain_6d_pose/PASCAL3D+_release1.1/Images/bus_imagenet',
    #     anno_path='/home/jiahao/pretrain_6d_pose/PASCAL3D+_release1.1/Annotations/bus_imagenet',
    #     #list_file='/home/jiahao/pretrain_6d_pose/PASCAL3D+_release1.1/Image_sets/bus_imagenet_train.txt',
    #     list_file='/home/jiahao/pretrain_6d_pose/test_pascal3d/bus_100.txt',
    #     category='bus',
    #     crop_object=True,
    ...
    #     print(sample['img_name'], '      ',sample['distance_orig'])
    # print('done')
    # exit()
...
def main():
    ...
    # shutil.copyfile(__file__, os.path.join(save_path, __file__)) # Xiaoding: why we need to do this?
    ...
    logging.info(f'Total itr:      {args.iterations * args.batch_size}')
